...
// --- IMPORT ROUTES ---
// [PENTING] Sesuaikan Huruf Besar/Kecil dengan nama file di GitHub Anda!
// Saya ubah ke Huruf Besar (Auth, Courses) untuk antisipasi error Case Sensitive.
import authRoutes from './routes/Auth'; 
import courseRoutes from './routes/Courses';
import userRoutes from './routes/Users';
import progressRoutes from './routes/Progress';
import certificateRoutes from './routes/Certificates';
import uploadRoutes from './routes/Upload';
import adminUserRoutes from './routes/admin-user'; // Cek apakah ini AdminUser.ts?
import forumRoutes from './routes/Forum';
import libraryRoutes from './routes/Library';
import contentRoutes from './routes/Content';
import quizRoutes from './routes/Quiz';
...
// Register Routes
// Pastikan variabel import di atas sesuai dengan yang dipakai di sini
app.use('/api/courses/certificate', certificateRoutes);
app.use('/api/auth', authRoutes);
app.use('/api/users', userRoutes);
app.use('/api/admin/users', adminUserRoutes);
