...
// // ==========================================
// // 1. KONFIGURASI FOLDER PENYIMPANAN (PASTI)
// // ==========================================
// // Kita gunakan path absolute agar tidak bingung
// const UPLOAD_PATH = path.resolve(process.cwd(), 'public/uploads');

// // Buat folder jika belum ada
// if (!fs.existsSync(UPLOAD_PATH)) {
//   console.log(`[Upload] Membuat folder baru di: ${UPLOAD_PATH}`);
//   fs.mkdirSync(UPLOAD_PATH, { recursive: true });
// } else {
//   console.log(`[Upload] Folder penyimpanan siap di: ${UPLOAD_PATH}`);
// }
...
// // A. UPLOAD GENERIC (Create Course / User Avatar)
// router.post('/', requireAuth, upload.single('file'), (req: any, res: any) => {
//   try {
//     if (!req.file) return res.status(400).json({ error: 'Tidak ada file.' });

//     // PENTING: URL ini harus match dengan static folder di app.ts
//     const relUrl = `/uploads/${req.file.filename}`; 
    
//     console.log(`[Upload Success] File saved to: ${req.file.path}`);
//     console.log(`[Upload Success] URL generated: ${relUrl}`);
...
// // B. UPLOAD COVER (Update Course Langsung)
...
//     console.log(`[Cover Updated] Course: ${course.title} -> ${relUrl}`);
