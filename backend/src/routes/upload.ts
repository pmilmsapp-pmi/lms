...
//       allowed_formats: ['jpg', 'png', 'jpeg', 'webp', 'pdf', 'mp4', 'doc', 'docx', 'mp3', 'wav', 'm4a'],
...
const storage = new CloudinaryStorage({
  ...
  params: async (req, file) => {
    ...
    if (req.originalUrl.includes('cover')) {
        ...
        // [BARU] Folder khusus Audio/Podcast
        folderName = 'humanis-lms/audio';
    }
    ...
    return {
      folder: folderName,
      // [FIX KRUSIAL] 'auto' wajib agar PDF & Audio dideteksi sebagai raw/video (bukan image)
      resource_type: 'auto', 
      
      // [FIX KRUSIAL] Paksa PUBLIC agar tidak "Blocked for delivery"
      access_mode: 'public', 
      
      // [UPDATE] Tambahkan format audio: mp3, wav, m4a, mpeg
      allowed_formats: ['jpg', 'png', 'jpeg', 'webp', 'pdf', 'mp4', 'doc', 'docx', 'mp3', 'wav', 'm4a', 'mpeg'],
