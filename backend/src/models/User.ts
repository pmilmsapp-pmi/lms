...
export interface IUser extends Document {
  ...
  // [BARU] Field untuk Sinkronisasi Data Import
  city?: string;
  province?: string;
  memberType?: string;
  memberData?: {
...
const UserSchema: Schema = new Schema({
  ...
  // [BARU] Definisi Schema untuk data wilayah & posisi
  city: { type: String, default: '' },
  province: { type: String, default: '' },
  memberType: { type: String, default: 'KSR' },
  memberData: { type: Schema.Types.Mixed, default: {} },
