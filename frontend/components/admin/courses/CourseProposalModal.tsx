...
// // // // // import { useState, useEffect } from 'react';
// // // // // import { Upload, Loader2, FileText, DollarSign, Calendar, MapPin, LayoutGrid, AlertCircle, User, Book, CheckCircle2, Trash2, Info } from 'lucide-react';
// // // // // import { api } from '@/lib/api';
// // // // // import BaseModal from '@/components/ui/BaseModal';
...
// // // // //     const isLockedRegion = currentUser && (
// // // // //         currentUser.role === 'FACILITATOR' || 
// // // // //         (currentUser.role === 'ADMIN' && currentUser.regionScope !== 'national')
// // // // //     );
...
// // // // //     // 2. Auto-Fill User Region
// // // // //     useEffect(() => {
// // // // //         if (isOpen && currentUser) {
// // // // //             setTitle(''); setDescription(''); setProgramType('training'); setUploadedFiles({}); setShowConfirm(false);

// // // // //             let defaultScope = 'national';
// // // // //             let defaultProvinces: string[] = [];
// // // // //             let defaultRegencies: string[] = [];

// // // // //             if (currentUser.role === 'FACILITATOR') {
// // // // //                 if (currentUser.city || currentUser.regency) {
// // // // //                     defaultScope = 'regency';
// // // // //                     defaultRegencies = [currentUser.city || currentUser.regency];
// // // // //                 } else if (currentUser.province) {
// // // // //                     defaultScope = 'province';
// // // // //                     defaultProvinces = [currentUser.province];
// // // // //                 }
// // // // //             } else if (currentUser.role === 'ADMIN') {
// // // // //                 defaultScope = currentUser.regionScope || 'national';
// // // // //                 defaultProvinces = currentUser.managedProvinces || [];
// // // // //                 defaultRegencies = currentUser.managedRegencies || [];
// // // // //             }
// // // // //             setRegionConfig({ scope: defaultScope, provinces: defaultProvinces, regencies: defaultRegencies });
// // // // //         }
// // // // //     }, [isOpen, currentUser]);
...
// // // // //             setUploadedFiles(prev => ({ ...prev, [docName]: { url: url, originalName: file.name } }));
// // // // //         } catch (e) { alert("Gagal upload file."); } finally { setUploadingKey(null); }
// // // // //     };

// // // // //     const removeFile = (docName: string) => {
// // // // //         if(!confirm("Hapus file ini?")) return;
// // // // //         const newFiles = { ...uploadedFiles }; delete newFiles[docName]; setUploadedFiles(newFiles);
// // // // //     };
...
// // // // //         const currentRequirements = programType === 'training' ? requiredDocsList : courseDocsList;
// // // // //         const missingDocs = currentRequirements.filter(docName => !uploadedFiles[docName]);
        
// // // // //         if (missingDocs.length > 0) return alert(`Mohon lengkapi dokumen wajib:\n- ${missingDocs.join('\n- ')}`);
// // // // //         if (regionConfig.scope === 'province' && regionConfig.provinces.length === 0) return alert("Pilih Provinsi");
...
// // // // //         setLoading(true);
// // // // //         try {
// // // // //             // [LOGIC ORGANIZER YANG DIPERBAIKI]
// // // // //             let organizerLabel = 'PMI Pusat';
// // // // //             let finalRegionCode = 'national';

// // // // //             // Cek scope dari state 'regionConfig' yang aktif di form
// // // // //             if (regionConfig.scope === 'province') {
// // // // //                 const provName = regionConfig.provinces[0] || '';
// // // // //                 organizerLabel = `PMI Provinsi ${provName}`;
// // // // //                 finalRegionCode = provName; // Simpan nama provinsi sebagai kode wilayah
// // // // //             } else if (regionConfig.scope === 'regency') {
// // // // //                 const cityName = regionConfig.regencies[0] || '';
// // // // //                 const provName = regionConfig.provinces[0] || ''; // Ambil juga provinsinya
// // // // //                 organizerLabel = `PMI ${cityName}`; // Label UI
// // // // //                 finalRegionCode = cityName; // Kode wilayah
// // // // //             }

// // // // //             const proposalDocuments = Object.entries(uploadedFiles).map(([key, val]) => ({
// // // // //                 name: val.originalName, url: val.url, label: key
// // // // //             }));
...
// // // // //                 proposalDocuments,
// // // // //                 facilitatorIds: [currentUser.id || currentUser._id],
                
// // // // //                 // [PENTING] Status 'proposed' = Masuk Tab Pengajuan Masuk
// // // // //                 status: 'proposed', 
// // // // //                 isPublished: false,
// // // // //                 isInfoCompleted: false
// // // // //             };
...
// // // // //             setShowConfirm(false);
// // // // //             onSuccess(); // Pemicu refresh & pindah tab di parent
// // // // //             onClose();
...
// // // // //     return (
// // // // //         <>
// // // // //         <BaseModal isOpen={isOpen} onClose={onClose} title="Pengajuan Pelatihan Baru" size="2xl">
// // // // //             <div className="p-5 max-h-[75vh] overflow-y-auto custom-scrollbar bg-gray-50/50">
...
// // // // //                     <div><p className="text-[10px] font-bold text-gray-400 uppercase tracking-widest">PENGAJU USULAN</p><h3 className="font-bold text-gray-800 text-sm">{currentUser?.name}</h3></div>
// // // // //                 </div>

// // // // //                 <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
// // // // //                     <div className="space-y-4">
// // // // //                         <div>
// // // // //                             <label className="text-[11px] font-bold text-gray-500 uppercase block mb-1">Judul Pelatihan *</label>
// // // // //                             <input aria-label="Judul Pelatihan" className="w-full px-3 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-red-500 outline-none text-sm font-medium" placeholder="Nama pelatihan..." value={title} onChange={(e) => setTitle(e.target.value)}/>
// // // // //                         </div>
// // // // //                         <div>
// // // // //                             <label className="text-[11px] font-bold text-gray-500 uppercase block mb-1">Jenis Program</label>
// // // // //                             <div className="flex gap-2">
// // // // //                                 <button aria-label="Pilih Diklat" onClick={() => setProgramType('training')} className={`flex-1 py-2 rounded-lg border text-xs font-bold flex items-center justify-center gap-2 ${programType === 'training' ? 'bg-red-50 border-red-500 text-red-600' : 'bg-white border-gray-300 text-gray-500'}`}><LayoutGrid size={14}/> DIKLAT</button>
// // // // //                                 <button aria-label="Pilih Kursus" onClick={() => setProgramType('course')} className={`flex-1 py-2 rounded-lg border text-xs font-bold flex items-center justify-center gap-2 ${programType === 'course' ? 'bg-blue-50 border-blue-500 text-blue-600' : 'bg-white border-gray-300 text-gray-500'}`}><Book size={14}/> KURSUS</button>
// // // // //                             </div>
// // // // //                         </div>
// // // // //                         <div>
// // // // //                             <label className="text-[11px] font-bold text-gray-500 uppercase block mb-1">Latar Belakang</label>
// // // // //                             <textarea aria-label="Latar Belakang" className="w-full px-3 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-red-500 outline-none text-sm h-32 resize-none" placeholder="Deskripsi singkat..." value={description} onChange={(e) => setDescription(e.target.value)}/>
// // // // //                         </div>
// // // // //                     </div>
// // // // //                     <div className="space-y-4">
// // // // //                         <div className={`p-4 rounded-xl border ${isLockedRegion ? 'bg-orange-50 border-orange-200' : 'bg-white border-gray-200'}`}>
// // // // //                             <div className="flex justify-between items-center mb-2">
// // // // //                                 <label className="text-[11px] font-bold text-gray-500 uppercase flex items-center gap-1"><MapPin size={12}/> PELAKSANA</label>
// // // // //                                 {isLockedRegion && <span className="text-[9px] font-bold bg-orange-100 text-orange-700 px-2 py-0.5 rounded-full border border-orange-200 flex items-center gap-1"><AlertCircle size={10}/> Terkunci (Wilayah Anda)</span>}
// // // // //                             </div>
// // // // //                             <RegionSelector value={regionConfig} onChange={setRegionConfig} disabled={isLockedRegion} />
// // // // //                         </div>
// // // // //                         <div>
// // // // //                             <div className="flex justify-between items-center mb-2">
// // // // //                                 <label className="text-[11px] font-bold text-gray-500 uppercase block">Dokumen Wajib <span className="text-red-500">*</span></label>
// // // // //                                 {configLoading && <span className="text-[9px] text-blue-500 animate-pulse">Syncing CMS...</span>}
// // // // //                             </div>
// // // // //                             <div className="space-y-2 max-h-[250px] overflow-y-auto pr-1 custom-scrollbar">
// // // // //                                 {activeRequirements.map((docName, idx) => {
// // // // //                                     const uploaded = uploadedFiles[docName];
// // // // //                                     return (
// // // // //                                         <div key={idx} className={`flex items-center justify-between p-2 border rounded-lg transition-colors ${uploaded ? 'bg-green-50 border-green-200' : 'bg-white border-gray-200 hover:border-gray-400'}`}>
// // // // //                                             <div className="flex items-center gap-2 overflow-hidden">
// // // // //                                                 <div className="p-1.5 bg-white rounded border border-gray-100 shadow-sm">{uploaded ? <CheckCircle2 size={14} className="text-green-600"/> : <FileText size={14} className="text-orange-500"/>}</div>
// // // // //                                                 <div className="flex flex-col"><span className="text-xs font-bold text-gray-700 truncate w-24 md:w-32" title={docName}>{docName}</span>{uploaded && <span className="text-[9px] text-green-600 font-medium truncate w-20">{uploaded.originalName}</span>}</div>
// // // // //                                             </div>
// // // // //                                             {uploaded ? (
// // // // //                                                 <button onClick={() => removeFile(docName)} className="p-1.5 text-red-400 hover:text-red-600 bg-white hover:bg-red-50 rounded border border-gray-200 transition-colors" aria-label="Hapus File"><Trash2 size={14}/></button>
// // // // //                                             ) : (
// // // // //                                                 <label className="px-3 py-1.5 bg-gray-100 hover:bg-gray-200 rounded text-[10px] font-bold cursor-pointer text-gray-600 flex items-center gap-1 transition-colors whitespace-nowrap">
// // // // //                                                     {uploadingKey === docName ? <Loader2 className="animate-spin" size={10}/> : <Upload size={10}/>} Upload
// // // // //                                                     <input aria-label={`Upload ${docName}`} type="file" className="hidden" accept=".pdf,.doc,.docx,.xlsx" onChange={(e) => e.target.files?.[0] && handleUpload(e.target.files[0], docName)} />
// // // // //                                                 </label>
// // // // //                                             )}
// // // // //                                         </div>
// // // // //                                     );
...
// // // // //                 </div>
// // // // //             </div>
// // // // //             <div className="p-4 border-t border-gray-200 bg-white rounded-b-xl flex gap-3">
// // // // //                 <button onClick={onClose} className="px-5 py-2.5 border rounded-lg font-bold text-sm hover:bg-gray-50 transition-colors text-gray-600">Batal</button>
// // // // //                 <button onClick={handlePreSubmit} disabled={loading || uploadingKey !== null} className="flex-1 bg-red-700 hover:bg-red-800 text-white py-2.5 rounded-lg font-bold text-sm shadow-md transition-all flex items-center justify-center gap-2 disabled:opacity-50">{loading ? <Loader2 className="animate-spin" size={16}/> : <FileText size={16}/>} KIRIM USULAN</button>
// // // // //             </div>
// // // // //         </BaseModal>

// // // // //         {showConfirm && (
// // // // //             <div className="fixed inset-0 z-[60] flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm animate-in fade-in">
// // // // //                 <div className="bg-white w-[350px] p-6 rounded-2xl shadow-2xl text-center space-y-4 animate-in zoom-in-95 relative">
// // // // //                     <div className="w-16 h-16 bg-blue-50 rounded-full flex items-center justify-center mx-auto text-blue-600 shadow-inner mb-2 ring-4 ring-blue-50"><Info size={32}/></div>
// // // // //                     <div>
// // // // //                         <h4 className="text-xl font-black text-gray-900 mb-2">Konfirmasi Pengajuan</h4>
// // // // //                         <p className="text-xs text-gray-500 leading-relaxed px-4">
// // // // //                             Usulan pelatihan ini akan dikirim ke <b>Tab Pengajuan Masuk</b> dan harus direview oleh Admin terlebih dahulu.
// // // // //                         </p>
// // // // //                     </div>
// // // // //                     <div className="flex gap-3 pt-2">
// // // // //                         <button onClick={() => setShowConfirm(false)} className="flex-1 py-3 border border-gray-300 rounded-xl text-xs font-bold text-gray-600 hover:bg-gray-50 transition-colors">Batal</button>
// // // // //                         <button onClick={handleFinalSubmit} disabled={loading} className="flex-[1.5] py-3 bg-blue-600 text-white rounded-xl text-xs font-bold hover:bg-blue-700 flex justify-center items-center gap-2 shadow-lg shadow-blue-200 transition-all active:scale-95">
// // // // //                             {loading ? <Loader2 size={16} className="animate-spin"/> : <CheckCircle2 size={16}/>} Ya, Kirim Sekarang
// // // // //                         </button>
// // // // //                     </div>
// // // // //                 </div>
// // // // //             </div>
...
// // // // import { useState, useEffect } from 'react';
// // // // import { Upload, Loader2, FileText, MapPin, LayoutGrid, User, Book, CheckCircle2, Trash2, Info, X, AlertCircle } from 'lucide-react';
// // // // import { api } from '@/lib/api';
// // // // import BaseModal from '@/components/ui/BaseModal';
// // // // import RegionSelector from '@/components/admin/RegionSelector';
// // // // import axios from 'axios';
// // // // // Import helper lokal untuk pencocokan Nama -> Kode
// // // // import { getProvinces, getRegencies } from '@/lib/indonesia'; 
...
// // // //     // State User Fresh (Diambil dari API untuk memastikan data province ada)
...
// // // //     // --- 1. LOGIC DETEKSI WILAYAH (AUTO TRANSLATE NAMA -> KODE) ---
// // // //     useEffect(() => {
// // // //         if (isOpen && freshUser) {
// // // //             // Reset Form
// // // //             setTitle(''); setDescription(''); setProgramType('training'); setUploadedFiles({}); setShowConfirm(false);

// // // //             // 1. Ambil Nama Wilayah User (Misal: "JAWA BARAT" dari DB)
...
// // // //             // 2. Load JSON Lokal (Untuk mendapatkan KODE)
// // // //             const localProvinces = getProvinces(); 

// // // //             let newScope = 'national';
// // // //             let newProvinces: string[] = []; // Array KODE (bukan nama)
// // // //             let newRegencies: string[] = []; // Array KODE

// // // //             // 3. Cek Managed Provinces (Kasus Ach Ilham - Punya Kode Langsung)
// // // //             if (freshUser.managedProvinces?.length > 0) {
// // // //                 // Asumsi di DB Ach Ilham tersimpan KODE "35", bukan Nama "JAWA TIMUR"
// // // //                 // Cek apakah stringnya angka (kode) atau huruf (nama)
// // // //                 const firstManaged = freshUser.managedProvinces[0];
// // // //                 const isCode = /^\d+$/.test(firstManaged); // Cek is numeric string

// // // //                 if (isCode) {
// // // //                     // Kasus Ach Ilham (Sudah Kode)
// // // //                     newScope = freshUser.regionScope || 'province';
// // // //                     newProvinces = freshUser.managedProvinces;
// // // //                     // Jika ada regencies code juga
// // // //                     if (freshUser.managedRegencies?.length > 0) {
// // // //                          newScope = 'regency';
// // // //                          newRegencies = freshUser.managedRegencies;
// // // //                     }
// // // //                 } else {
// // // //                     // Kasus Nama di managedProvinces (Jarang, tapi handle saja)
// // // //                     rawProv = firstManaged.toUpperCase();
// // // //                 }
// // // //             }

// // // //             // 4. Kasus Rita (Hanya punya Nama "JAWA BARAT") -> Cari Kodenya di JSON
// // // //             if (newProvinces.length === 0 && rawProv) {
// // // //                 // Cari objek provinsi di JSON yang namanya cocok
// // // //                 const matchedProv = localProvinces.find((p: any) => 
// // // //                     p.name.toUpperCase() === rawProv
// // // //                 );

// // // //                 if (matchedProv) {
// // // //                     console.log(`✅ MATCH: ${rawProv} -> Code: ${matchedProv.code}`);
                    
// // // //                     if (isLockedRegion) {
// // // //                         const isCityLevel = rawCity && (freshUser.role === 'FACILITATOR' || freshUser.regionScope === 'regency');

// // // //                         if (isCityLevel) {
// // // //                             // Level Kota
// // // //                             newScope = 'regency';
// // // //                             newProvinces = [matchedProv.code]; // Simpan KODE

// // // //                             // Cari Kode Kota
// // // //                             const localRegencies = getRegencies(matchedProv.code);
// // // //                             const matchedCity = localRegencies.find((r: any) => 
// // // //                                 r.name.toUpperCase().includes(rawCity) || rawCity.includes(r.name.toUpperCase())
// // // //                             );

// // // //                             if (matchedCity) {
// // // //                                 newRegencies = [matchedCity.code]; // Simpan KODE
// // // //                             }
// // // //                         } else {
// // // //                             // Level Provinsi
// // // //                             newScope = 'province';
...
// // // //             // 5. Update State (Hanya jika terkunci & valid, agar tidak overwrite default nasional)
...
// // // //             // Ambil Nama dari Kode (Lookup ke JSON) untuk label Organizer
// // // //             const localProvs = getProvinces();
// // // //             const pCode = provinces[0];
// // // //             const pName = pCode ? localProvs.find((p:any) => p.code === pCode)?.name : '';
...
// // // //             if (scope === 'province') {
// // // //                 organizerLabel = `PMI Provinsi: ${pName}`;
// // // //                 finalRegionCode = pCode; 
// // // //             } else if (scope === 'regency') {
// // // //                 organizerLabel = `PMI: ${cName}`;
...
// // // //                     {/* [FIX ACCESSIBILITY] Tambah aria-label & title */}
// // // //                     <button onClick={onClose} className="hover:bg-white/20 p-1 rounded-full" aria-label="Tutup Modal" title="Tutup">
// // // //                         <X size={24}/>
// // // //                     </button>
// // // //                 </div>
...
// // // //                                 <span className="bg-blue-100 text-blue-700 px-2 py-0.5 rounded text-[10px] font-bold uppercase border border-blue-200">
// // // //                                     {freshUser?.role}
// // // //                                 </span>
...
// // // //                             <div><label className="text-[11px] font-bold text-gray-500 uppercase block mb-1">JUDUL USULAN *</label><input aria-label="Judul Pelatihan" className="w-full p-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#990000] outline-none font-bold text-gray-800" placeholder="Contoh: Diklat..." value={title} onChange={(e) => setTitle(e.target.value)}/></div>
// // // //                             <div>
// // // //                                 <label className="text-[11px] font-bold text-gray-500 uppercase block mb-1">JENIS PROGRAM</label>
// // // //                                 <div className="grid grid-cols-2 gap-3">
// // // //                                     {/* [FIX ACCESSIBILITY] Tambah aria-label */}
// // // //                                     <button onClick={() => setProgramType('training')} aria-label="Pilih Jenis Diklat" className={`py-2.5 rounded-lg border text-sm font-bold flex items-center justify-center gap-2 ${programType === 'training' ? 'bg-red-50 border-[#990000] text-[#990000]' : 'bg-white border-gray-300 text-gray-500'}`}><LayoutGrid size={16}/> DIKLAT</button>
// // // //                                     <button onClick={() => setProgramType('course')} aria-label="Pilih Jenis Kursus" className={`py-2.5 rounded-lg border text-sm font-bold flex items-center justify-center gap-2 ${programType === 'course' ? 'bg-blue-50 border-blue-500 text-blue-600' : 'bg-white border-gray-300 text-gray-500'}`}><Book size={16}/> KURSUS</button>
// // // //                                 </div>
// // // //                             </div>
// // // //                             <div><label className="text-[11px] font-bold text-gray-500 uppercase block mb-1">ALASAN / LATAR BELAKANG</label><textarea aria-label="Latar Belakang" className="w-full p-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#990000] outline-none h-32 resize-none" placeholder="Jelaskan..." value={description} onChange={(e) => setDescription(e.target.value)}/></div>
// // // //                         </div>

// // // //                         <div className="lg:col-span-5 space-y-6">
// // // //                             <div className={`p-4 rounded-xl border ${isLockedRegion ? 'bg-orange-50 border-orange-200' : 'bg-white border-gray-200'}`}>
// // // //                                 <label className="text-[11px] font-bold text-orange-800 uppercase flex items-center gap-1 mb-2">
// // // //                                     <MapPin size={12}/> PELAKSANA {isLockedRegion && "(TERKUNCI)"}
// // // //                                 </label>
// // // //                                 {/* Region Selector dengan Prop Disabled */}
// // // //                                 <RegionSelector value={regionConfig} onChange={setRegionConfig} disabled={isLockedRegion} />
// // // //                             </div>
...
// // // //                                     {activeRequirements.map((docName, idx) => (
// // // //                                         <div key={idx} className={`p-3 border rounded-lg ${uploadedFiles[docName] ? 'border-green-300 bg-green-50' : 'border-gray-200 bg-white'}`}>
// // // //                                             <div className="flex items-center gap-2 mb-2">{uploadedFiles[docName] ? <CheckCircle2 size={14} className="text-green-600"/> : <AlertCircle size={14} className="text-orange-500"/>}<span className="text-xs font-bold text-gray-700 truncate">{docName} <span className="text-red-500">*</span></span></div>
// // // //                                             {uploadedFiles[docName] ? (
// // // //                                                 <div className="flex justify-between items-center bg-white p-2 rounded border border-green-100">
// // // //                                                     <span className="text-[10px] font-bold text-green-700 truncate w-32">{uploadedFiles[docName].originalName}</span>
// // // //                                                     {/* [FIX ACCESSIBILITY] Tambah aria-label & title */}
// // // //                                                     <button onClick={() => { const n={...uploadedFiles}; delete n[docName]; setUploadedFiles(n); }} className="text-red-500 hover:bg-red-50 p-1 rounded" aria-label="Hapus File" title="Hapus File"><Trash2 size={12}/></button>
// // // //                                                 </div>
// // // //                                             ) : (
// // // //                                                 <label className="w-full flex items-center justify-center gap-2 py-2 bg-blue-50 border border-blue-200 text-blue-700 rounded text-[10px] font-bold cursor-pointer hover:bg-blue-100 transition-colors">
// // // //                                                     {uploadingKey === docName ? <Loader2 className="animate-spin" size={12}/> : <Upload size={12}/>} Upload File
// // // //                                                     <input type="file" aria-label={`Upload ${docName}`} className="hidden" accept=".pdf,.doc,.docx" onChange={(e) => e.target.files?.[0] && handleUpload(e.target.files[0], docName)}/>
// // // //                                                 </label>
// // // //                                             )}
// // // //                                         </div>
// // // //                                     ))}
...
// // // //                     <button onClick={onClose} className="flex-1 py-3 border border-gray-300 rounded-lg font-bold text-sm text-gray-600 hover:bg-white transition-colors">Batal</button>
// // // //                     {/* [FIX ACCESSIBILITY] Tambah aria-label */}
// // // //                     <button onClick={handlePreSubmit} aria-label="Kirim Usulan Pelatihan" disabled={loading} className="flex-[3] py-3 bg-[#990000] text-white rounded-lg font-bold text-sm hover:bg-[#7f0000] shadow-md flex items-center justify-center gap-2">{loading ? <Loader2 className="animate-spin" size={18}/> : <FileText size={18}/>} KIRIM USULAN</button>
// // // //                 </div>
// // // //             </div>
// // // //         </BaseModal>

// // // //         {/* [FIX Z-INDEX] Set ke 100 agar muncul di atas modal utama */}
// // // //         {showConfirm && (
// // // //             <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm animate-in fade-in">
// // // //                 <div className="bg-white w-[350px] p-6 rounded-xl shadow-2xl text-center space-y-4 animate-in zoom-in-95">
// // // //                     <div className="w-14 h-14 bg-blue-100 rounded-full flex items-center justify-center mx-auto text-blue-600"><Info size={28}/></div>
// // // //                     <div><h4 className="font-bold text-gray-900">Konfirmasi</h4><p className="text-xs text-gray-500 mt-1">Kirim usulan ini ke <b>Pengajuan Masuk</b>?</p></div>
// // // //                     <div className="flex gap-2 mt-2">
// // // //                         <button onClick={() => setShowConfirm(false)} className="flex-1 py-2 border rounded-lg text-xs font-bold">Batal</button>
// // // //                         <button onClick={handleFinalSubmit} disabled={loading} className="flex-1 py-2 bg-blue-600 text-white rounded-lg text-xs font-bold flex items-center justify-center gap-2">
// // // //                             {loading ? <Loader2 className="animate-spin" size={14}/> : 'Ya, Kirim'}
// // // //                         </button>
// // // //                     </div>
// // // //                 </div>
// // // //             </div>
...
// // //             // DETEKSI BERDASARKAN MANAGED SCOPE (DB)
// // //             if (freshUser.managedProvinces?.length > 0) {
// // //                 // Konversi Nama/Kode -> Kode
...
// // //                             if (matchedCity) newRegencies = [matchedCity.code];
// // //                         }
// // //                     } else if (freshUser.regionScope === 'province') {
// // //                         newScope = 'province';
// // //                     }
// // //                 }
// // //             } 
...
// // //                 if (matchedProv) {
// // //                     if (isLockedRegion) {
// // //                         if ((freshUser.role === 'FACILITATOR' || freshUser.regionScope === 'regency') && rawCity) {
// // //                             newScope = 'regency';
// // //                             newProvinces = [matchedProv.code];
// // //                             const localRegs = getRegencies(matchedProv.code);
...
// // //         const reqs = programType === 'training' ? requiredDocsList : courseDocsList;
// // //         if (reqs.some(d => !uploadedFiles[d])) return alert("Lengkapi dokumen wajib");
// // //         if (!isLockedRegion && regionConfig.scope !== 'national' && regionConfig.provinces.length === 0) return alert("Pilih Wilayah");
// // //         setShowConfirm(true);
// // //     };
...
// // //                     <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
// // //                         <div className="lg:col-span-7 space-y-5">
// // //                             <div><label className="text-[11px] font-bold text-gray-500 uppercase block mb-1">JUDUL USULAN *</label><input className="w-full p-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#990000] outline-none font-bold text-gray-800" placeholder="Contoh: Diklat..." value={title} onChange={(e) => setTitle(e.target.value)} aria-label="Judul"/></div>
// // //                             <div>
// // //                                 <label className="text-[11px] font-bold text-gray-500 uppercase block mb-1">JENIS PROGRAM</label>
// // //                                 <div className="grid grid-cols-2 gap-3">
...
// // import RegionSelector from '@/components/admin/RegionSelector';
// // import axios from 'axios';
// // // Helper lokal untuk data wilayah
// // import { getProvinces, getRegencies } from '@/lib/indonesia'; 
...
// //     // State User Fresh (Data terbaru dari API)
// //     const [freshUser, setFreshUser] = useState<any>(currentUser);
...
// //     // Kunci wilayah jika Fasilitator atau Admin Daerah
// //     const isLockedRegion = freshUser && (
// //         freshUser.role === 'FACILITATOR' || 
// //         (freshUser.role === 'ADMIN' && freshUser.regionScope !== 'national')
// //     );

// //     // 0. FETCH FRESH USER DATA
// //     useEffect(() => {
// //         const loadFreshUser = async () => {
// //             if (!isOpen) return;
// //             try {
// //                 // Ambil data detail user agar field 'province'/'managedProvinces' tidak kosong
// //                 const res = await api('/api/auth/me').catch(()=>null) || await api('/api/users/me').catch(()=>null);
// //                 if(res && (res.user || res.id)) setFreshUser(res.user || res);
// //             } catch (e) { console.error(e); }
// //         };
...
// //     // 1. LOGIC DETEKSI WILAYAH (AUTO FILL)
// //     useEffect(() => {
// //         if (isOpen && freshUser) {
// //             setTitle(''); setDescription(''); setProgramType('training'); setUploadedFiles({}); setShowConfirm(false);

// //             // Normalisasi data dari DB (Biasanya Uppercase)
// //             let rawProv = freshUser.province || freshUser.memberData?.province || '';
// //             let rawCity = freshUser.city || freshUser.memberData?.regency || '';
// //             rawProv = rawProv.trim().toUpperCase();
// //             rawCity = rawCity.trim().toUpperCase();
...
// //             // A. Cek Managed Scope (Prioritas Admin/Fasilitator yang sudah diset via Edit User)
// //             if (freshUser.managedProvinces?.length > 0) {
// //                 const managedItem = freshUser.managedProvinces[0];
// //                 // Cari kode provinsi berdasarkan nama atau kode
// //                 const matchedProv = localProvinces.find((p: any) => 
// //                     p.name.toUpperCase() === managedItem.toUpperCase() || p.code === managedItem
// //                 );
...
// //                             if (matchedCity) newRegencies = [matchedCity.code];
// //                         } 
// //                         // Fallback ke data domisili jika managed kosong
// //                         else if (rawCity) {
// //                             const localRegs = getRegencies(matchedProv.code);
// //                             const matchedCity = localRegs.find((r: any) => 
// //                                 r.name.toUpperCase().includes(rawCity) || rawCity.includes(r.name.toUpperCase())
...
// //                 }
// //             } 
// //             // B. Fallback ke Data Domisili Biasa
// //             else if (rawProv) {
// //                 const matchedProv = localProvinces.find((p: any) => p.name.toUpperCase() === rawProv);
// //                 if (matchedProv) {
// //                     if (isLockedRegion) {
// //                         if (freshUser.role === 'FACILITATOR' && rawCity) {
// //                             // Fasilitator defaultnya ikut kota jika ada
// //                             newScope = 'regency';
// //                             newProvinces = [matchedProv.code];
// //                             const localRegs = getRegencies(matchedProv.code);
// //                             const matchedCity = localRegs.find((r: any) => r.name.toUpperCase().includes(rawCity) || rawCity.includes(r.name.toUpperCase()));
...
// //     // --- DISPLAY LABEL LOKASI (Prioritas Kota) ---
// //     const userLocationDisplay = () => {
// //         // Cek Region Config yang terdeteksi dulu (karena ini sudah hasil validasi kode)
// //         if (regionConfig.scope === 'regency' && regionConfig.regencies.length > 0) {
// //             const pCode = regionConfig.provinces[0];
// //             if(pCode) {
// //                 const regs = getRegencies(pCode);
...
// //                             <div className="flex items-center gap-2 mt-1">
// //                                 <span className="bg-blue-100 text-blue-700 px-2 py-0.5 rounded text-[10px] font-bold uppercase border border-blue-200">{freshUser?.role}</span>
// //                                 {/* LABEL LOKASI YANG SUDAH DIPERBAIKI */}
// //                                 <div className="flex items-center gap-1 text-xs text-gray-600 bg-white px-2 py-0.5 rounded border border-gray-200">
// //                                     <MapPin size={12} className="text-orange-500"/>
// //                                     <span className="font-bold uppercase tracking-tight">{userLocationDisplay()}</span>
// //                                 </div>
...
// //         {/* Z-INDEX FIX: Agar muncul di paling atas */}
...
import { useState, useEffect } from 'react';
// [FIX] AlertCircle ditambahkan ke import
import { Upload, Loader2, FileText, MapPin, LayoutGrid, User, Book, CheckCircle2, Trash2, Info, X, AlertCircle } from 'lucide-react';
import { api } from '@/lib/api';
import BaseModal from '@/components/ui/BaseModal';
import RegionSelector from '@/components/admin/RegionSelector';
