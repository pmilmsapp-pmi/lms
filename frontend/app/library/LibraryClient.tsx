            ...
            {filteredBooks.map((book) => {
              ...
              return (
                <div
                  key={book._id}
                  id={`book-${book._id}`}
                  className={`relative rounded-xl overflow-hidden flex flex-col group h-full transition-all duration-500
                    ${
                      isHighlighted
                        ? 'ring-4 ring-red-500 shadow-2xl scale-105 z-10 bg-red-50'
                ...
                >
                  ...
                  <div className="p-4 flex flex-col flex-1">
                    <h3
                      className="font-bold text-gray-800 leading-snug mb-1 line-clamp-2 text-sm"
                      title={book.title}
                    >
                      {book.title}
                    </h3>
