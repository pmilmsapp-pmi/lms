...
// // import { api, getImageUrl } from '@/lib/api'; // Pastikan getImageUrl diimport
...
// //       if (res.user.role === 'SUPER_ADMIN' || res.user.role === 'FACILITATOR') {
// //         setIsAdmin(true);
// //       }
...
// //   if (loading) return <div className="p-20 text-center text-gray-500">Memuat Perpustakaan...</div>;
...
// //                 <p className="text-gray-500 mt-1">Kumpulan panduan, SOP, dan referensi pelatihan.</p>
// //             </div>
// //             {isAdmin && (
// //                 <a href="/admin/library" className="bg-red-700 text-white px-5 py-2 rounded-lg font-bold hover:bg-red-800 transition-colors shadow-sm">
// //                     + Kelola Buku
// //                 </a>
// //             )}
// //         </div>
...
// //                 <p className="text-gray-400">Belum ada materi di perpustakaan.</p>
// //             </div>
// //         ) : (
// //             <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
// //                 {books.map((book) => (
// //                     <div key={book._id} className="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden hover:shadow-md transition-all group flex flex-col h-full">
                        
// //                         {/* Cover Image Wrapper */}
// //                         <div className="relative aspect-[3/4] bg-gray-100 overflow-hidden border-b border-gray-100">
// //                             {/* 1. PERBAIKAN COVER IMAGE: Gunakan getImageUrl */}
// //                             <img 
// //                                 src={getImageUrl(book.coverUrl) || 'https://via.placeholder.com/300x400?text=No+Cover'} 
// //                                 alt={book.title} 
// //                                 className="w-full h-full object-cover transition-transform duration-500 group-hover:scale-105"
// //                                 onError={(e) => { (e.target as HTMLImageElement).src = 'https://via.placeholder.com/300x400?text=No+Cover'; }} // Fallback jika error
// //                             />
                            
// //                             <div className="absolute top-2 left-2">
// //                                 <span className="bg-white/90 backdrop-blur-sm px-2 py-1 rounded text-[10px] font-bold text-gray-700 uppercase tracking-wide shadow-sm border border-gray-200">
// //                                     {book.category || 'Umum'}
// //                                 </span>
// //                             </div>
// //                         </div>
...
// //                             <h3 className="font-bold text-gray-800 mb-1 line-clamp-2 leading-tight" title={book.title}>
// //                                 {book.title}
// //                             </h3>
// //                             <p className="text-xs text-gray-500 mb-4">{book.year || new Date().getFullYear()}</p>
                            
// //                             <div className="mt-auto space-y-2">
// //                                 {/* 2. PERBAIKAN LINK DOWNLOAD: Gunakan getImageUrl untuk file PDF juga */}
// //                                 <a 
// //                                     href={getImageUrl(book.fileUrl)} 
// //                                     target="_blank" 
// //                                     rel="noopener noreferrer" // Security best practice
// //                                     className="block w-full bg-red-50 text-red-700 text-center py-2 rounded-lg text-xs font-bold hover:bg-red-100 transition-colors"
// //                                 >
// //                                     BACA / UNDUH
// //                                 </a>
...
// //                                         className="block w-full text-gray-400 text-[10px] hover:text-red-600 transition-colors"
// //                                     >
// //                                         Hapus Buku
// //                                     </button>
// //                                 )}
...
//     try {
//       setLoading(true);
//       // Panggil tanpa filter status, backend default akan kasih 'published'
//       const res = await api('/api/library');
//       // Handle jika response array langsung atau object { books: [] }
...
//         {/* LIST BUKU - TAMPILAN PORTRAIT GRID */}
//         {loading ? (
...
//                     <div key={book._id} className="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden hover:shadow-md transition-all flex flex-col group h-full">
                        
//                         {/* COVER IMAGE - PORTRAIT ASPECT RATIO 3:4 */}
//                         <div className="relative aspect-[3/4] bg-gray-100 overflow-hidden border-b border-gray-100">
//                             <img 
//                                 src={getImageUrl(book.coverUrl) || 'https://via.placeholder.com/300x400?text=No+Cover'} 
//                                 alt={book.title} 
